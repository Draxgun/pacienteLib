...
let addPatientModalContent = () => {
    ...
    ;(0,_modalCreators__WEBPACK_IMPORTED_MODULE_1__.createModalStructure)(mainForm,'modal','addPatientModal',addButton)
    return mainForm
